...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        private final static int CHUNKS_RANGE = 10000;
        ...
        protected void compute() {
            ...
            if(endIndexExclusive - startIndexInclusive <= CHUNKS_RANGE) {
                double sum = 0;
                ...
                ReciprocalArraySumTask leftPart = new ReciprocalArraySumTask(startIndexInclusive, middle, input);
                ReciprocalArraySumTask rightPart = new ReciprocalArraySumTask(middle, endIndexExclusive, input);
